  ...
  return (
    <div className="login-wrap">
      ...
      <div className="login-card chamfer">
        ...
        {errorMsg && <div className="login-err">
          {`// ${errorMsg}`}
        </div>}
        <form onSubmit={handleSubmit}>
          <div className="field">
            ...
            <input
              ...
              required
              className="chamfer h-10 px-3 bg-black/40 border border-neon-line font-mono
               text-[14px] text-(--fg) placeholder:text-(--color-muted-foreground) focus:outline-none
               focus:border-neon-green focus:shadow-[0_0_0_3px_rgba(182,255,60,0.15)] transition-shadow w-full"
            />
          </div>
          <div className="field">
            ...
            <input
              ...
              focus:shadow-[0_0_0_3px_rgba(182,255,60,0.15)] transition-shadow w-full"
            />
          </div>
          <Button type="submit"
            disabled={loading}
